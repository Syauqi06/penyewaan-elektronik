        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex space-x-8">
                    <a href="{{ route('katalog.index') }}" class="text-blue-700 font-semibold border-b-2 border-blue-700 pb-1">Jelajah</a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative lg:ml-auto">
                    ...
                    <div class="absolute -bottom-6 -left-6 bg-white/90 backdrop-blur-sm p-4 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-bold text-gray-900">Pembayaran Aman</p>
                            <p class="text-xs text-gray-500">Deposit dicairkan 100%</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-slate-50 p-8 rounded-2xl relative">
                    ...
                    <p class="text-gray-600 leading-relaxed">"Sangat merekomendasikan Rental.ly! Proses sewa kamera Sony A7III sangat cepat, barangnya dalam kondisi sempurna, dan fitur depositnya juga sangat transparan."</p>
                </div>
                <div class="bg-slate-50 p-8 rounded-2xl relative">
                    <svg class="absolute top-6 right-6 w-10 h-10 text-gray-200" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" /></svg>
                    <div class="flex items-center gap-4 mb-6">
                ...
                <div class="bg-slate-50 p-8 rounded-2xl relative">
                    ...
                    <p class="text-gray-600 leading-relaxed">"Platform rental paling rapi yang pernah saya temui. Tampilan UI-nya bersih, cek ketersediaan stok real-time, dan pengembalian depositnya instan tanpa drama."</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li>Jl. Teknologi No. 12, Jakarta</li>
